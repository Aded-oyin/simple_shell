...
/**
 * _myhistory - It will display the history list, one command by line, preceded
...
/**
 * _myalias - This right here mimics the alias builtin (man alias)
 * @info: Structure containing potential arguments. Used to maintain
 *          constant function prototype.
 *  Return: Always 0
 */
